...
var Dashboard = {
    ...
    loadZoneData : function() {
        ...
        var resourceCountRestStore = new JsonRest({
            target: core.getContextPath()+"/api/virtualMachine/count/byZone"
        }); 
        
        dojo.byId("dashboardDivLoader").style.display = "block";
        dojo.byId("dashboardDiv").style.display = "none";
        
        dojo.byId("vmStatsBox").innerHTML = "";
        dojo.byId("storageStatsBox").innerHTML = "";
        dojo.byId("snapshotStatsBox").innerHTML = "";
        dojo.byId("networkStatsBox").innerHTML = "";
        dojo.byId("bandwidthStatsBox").innerHTML = "";
        dojo.byId("VPCStatsBox").innerHTML = "";
        
        resourceCountRestStore.query({zoneReferenceId: dojo.byId("selectedANZoneID").value !== "All" ? dojo.byId("selectedANZoneID").value : null }).then(function(data) {
            dojo.forEach(data, function(zoneData) { 
                var currency = zoneData.currency;
                if(dojo.byId("selectedANZoneID").value !== "All" && dojo.byId("selectedANZoneID").value !== null && dojo.byId("selectedANZoneID").value !== "") {
                  
                    var zoneNode = document.createElement('div');   
                    zoneNode.className = 'zone-1';
                    zoneNode.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-vm_icon" ></i>'+zoneData.totalRunningVm+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalRunningVmCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("vmStatsBox").appendChild(zoneNode); 
                    
                    var zoneStotage = document.createElement('div');   
                    zoneStotage.className = 'zone-1';
                    zoneStotage.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-storage_icon" ></i>'+zoneData.totalStorage+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalVolumeCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("storageStatsBox").appendChild(zoneStotage); 
                    
                    var zoneSnap = document.createElement('div');   
                    zoneSnap.className = 'zone-1';
                    zoneSnap.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-snapshot_icon" ></i>'+zoneData.totalSnapshot+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalSnapCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("snapshotStatsBox").appendChild(zoneSnap); 
                    
                    var zoneNetwork = document.createElement('div');   
                    zoneNetwork.className = 'zone-1';
                    zoneNetwork.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneData.totalNetwork+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalNetworkCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("networkStatsBox").appendChild(zoneNetwork);
                    
                    
                    var zoneBandWidth = document.createElement('div');   
                    zoneBandWidth.className = 'zone-1';
                    zoneBandWidth.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneData.totalBandwidth + ' ' + translator.common.gb +'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalBandwidthCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("bandwidthStatsBox").appendChild(zoneBandWidth);
                   
                    var VPCNodeBandwidth = document.createElement('div');   
                    VPCNodeBandwidth.className = 'zone-1';
                    VPCNodeBandwidth.innerHTML = '<div class="zone-titles">'+zoneData.zoneName+'</div><div class="zone-counts"><i class="iconfg-vpc_icon" ></i>'+zoneData.totalVpc+'</div><div class="zone-pricing">'+LocaleNumber.format(0.00, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("VPCStatsBox").appendChild(VPCNodeBandwidth);
                    
                                        
                                       
                } else if(dojo.byId("selectedANZoneID").value !== null || dojo.byId("selectedANZoneID").value !== "") {
                    
                    var count = 1;
//                    var networkCount = 1;
//                    dojo.forEach(zoneData.zoneCount, function(zoneNetworkData) { 
//                        
//                        if(zoneNetworkData.type === "Advanced") {
//                            var zoneNodeNetwork = document.createElement('div');      
//                            zoneNodeNetwork.className = 'zone-'+networkCount;
//                            zoneNodeNetwork.innerHTML = '<div class="zone-titles">'+zoneNetworkData.zone+'</div><div class="zone-counts"><img src="images/statsBox/network.png" />'+zoneNetworkData.network+'</div><div class="zone-pricing">'+zoneNetworkData.networkCost+'</div>';
//                            dojo.byId("networkStatsBox").appendChild(zoneNodeNetwork);
//                            
//                            networkCount++;
//                        }
//                    });
                                        
                    dojo.forEach(zoneData.zoneCount, function(zoneItemData) {
                        var zoneNode = document.createElement('div');      
                        zoneNode.className = 'zone-'+count;
                        zoneNode.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-vm_icon" ></i>'+zoneItemData.runningVm+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.runningVmCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                        dojo.byId("vmStatsBox").appendChild(zoneNode); 
                        
                        var zoneNodeSorage = document.createElement('div');      
                        zoneNodeSorage.className = 'zone-'+count;
                        zoneNodeSorage.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-storage_icon" ></i>'+zoneItemData.storage+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.volumeCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                        dojo.byId("storageStatsBox").appendChild(zoneNodeSorage); 
                        
                        var zoneNodeSnap = document.createElement('div');      
                        zoneNodeSnap.className = 'zone-'+count;
                        zoneNodeSnap.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-snapshot_icon" ></i>'+zoneItemData.snapshot+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.snapCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                        dojo.byId("snapshotStatsBox").appendChild(zoneNodeSnap);
                                 
                         var zoneNodeNetwork = document.createElement('div');      
                        zoneNodeNetwork.className = 'zone-'+count;
                        zoneNodeNetwork.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneItemData.network+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.networkCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                        dojo.byId("networkStatsBox").appendChild(zoneNodeNetwork);
                        
                        
                        var zoneNodeBandwidth = document.createElement('div');      
                        zoneNodeBandwidth.className = 'zone-'+count;
                        zoneNodeBandwidth.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneItemData.bandwidth + ' ' + translator.common.gb +'</div><div class="zone-pricing">'+LocaleNumber.format(zoneItemData.bandwidthCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                        dojo.byId("bandwidthStatsBox").appendChild(zoneNodeBandwidth);
                        
                        var VPCNodeBandwidth = document.createElement('div');      
                        VPCNodeBandwidth.className = 'zone-'+count;
                        VPCNodeBandwidth.innerHTML = '<div class="zone-titles">'+zoneItemData.zone+'</div><div class="zone-counts"><i class="iconfg-vpc_icon" ></i>'+zoneItemData.vpc+'</div><div class="zone-pricing">'+LocaleNumber.format(0.00, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                        dojo.byId("VPCStatsBox").appendChild(VPCNodeBandwidth);
                    ...
                    var zoneNode = document.createElement('div');   
                    zoneNode.className = 'zone-'+count;                    
                    zoneNode.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-vm_icon" ></i>'+zoneData.totalRunningVm+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalRunningVmCost, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("vmStatsBox").appendChild(zoneNode);                      
                    var zoneStotage = document.createElement('div');   
                    zoneStotage.className = 'zone-'+count;                    
                    zoneStotage.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-storage_icon" ></i>'+zoneData.totalStorage+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalVolumeCost ,{places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("storageStatsBox").appendChild(zoneStotage); 
                    
                    var zoneSnap = document.createElement('div');   
                    zoneSnap.className = 'zone-'+count;
                    zoneSnap.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-snapshot_icon" ></i>'+zoneData.totalSnapshot+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalSnapCost ,{places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("snapshotStatsBox").appendChild(zoneSnap); 
                    
                    var zoneNetwork = document.createElement('div');   
                    zoneNetwork.className = 'zone-'+count;
                    zoneNetwork.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneData.totalNetwork+'</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalNetworkCost ,{places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("networkStatsBox").appendChild(zoneNetwork); 
                    
                    var zoneBandwidth = document.createElement('div');   
                    zoneBandwidth.className = 'zone-'+count;
                    zoneBandwidth.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-netwrk_icon" ></i>'+zoneData.totalBandwidth + ' ' + translator.common.gb + '</div><div class="zone-pricing">'+LocaleNumber.format(zoneData.totalBandwidthCost ,{places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("bandwidthStatsBox").appendChild(zoneBandwidth);
                    
                    var VPCNodeBandwidth = document.createElement('div');   
                    VPCNodeBandwidth.className = 'zone-'+count;
                    VPCNodeBandwidth.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-vpc_icon" ></i>'+zoneData.totalVpc+ '</div><div class="zone-pricing">'+LocaleNumber.format(0.00 ,{places: 2, locale: dojo.locale})+" "+currency+'</div>';
                    dojo.byId("VPCStatsBox").appendChild(VPCNodeBandwidth);
...
//                    });
                    ...
                    dojo.forEach(zoneData.zoneCount, function(zoneItemData) { 
                        ...
                        var VPCNodeBandwidth = document.createElement('div');   
                        VPCNodeBandwidth.className = 'zone-'+count;
                        VPCNodeBandwidth.innerHTML = '<div class="zone-titles">'+translator.common.all+'</div><div class="zone-counts"><i class="iconfg-vpc_icon" ></i>'+zoneItemData.vpc+ '</div><div class="zone-pricing">'+LocaleNumber.format(0.00, {places: 2, locale: dojo.locale})+" "+currency+'</div>';
                        dojo.byId("VPCStatsBox").appendChild(VPCNodeBandwidth);
    ...
    populateValues: function() { 
        ...
        this._accountListStore.query().then(function(data) {
            dojo.forEach(data, function(el) { 
                dojo.byId("usageCost").innerHTML = LocaleNumber.format(el.daily, {places: 2, locale: dojo.locale});
                ...
                dojo.byId("currentDue").innerHTML =  LocaleNumber.format(el.currentDue, {places: 2, locale: dojo.locale});
                
                dojo.byId("Payments").innerHTML = LocaleNumber.format(el.payments, {places: 2, locale: dojo.locale});
                ...
                dojo.byId("vmRunningAmount").innerHTML = el.currency +" "+ el.runningVmCost; 
                dojo.byId("vmStopAmount").innerHTML =  el.currency +" "+ el.stopVmCost;
                dojo.byId("diskAmount").innerHTML =  el.currency +" "+ el.totalDiskCost; 
                dojo.byId("snapAmount").innerHTML =  el.currency +" "+ el.totalSnapCost;
                dojo.byId("bandWidthCount").innerHTML = el.totalBandwidth + translator.common.gb;  
                dojo.byId("bandWidthAmount").innerHTML =  el.currency +" "+ el.totalBandwidthCost;
                userName = el.userName;
                singleSignOnUrl = el.singleSignOnUrl+"/api";                
                if(el.invoice == "no") {
...
//            
//            
//            //working singleSignOnUrl post request
//            console.log("************** SSO "); 
//            dojo.xhrPost({
//                // The URL of the request
//                url: singleSignOnUrl,
//                headers: {  "Access-Control-Allow-Origin":value="http://localhost:7070"
//                        },
//                content: {
//                    command:"login",
//                    domain:"/",
...
var Events = {
    ...
    populateValues : function() {
        ...
        dojo.byId("eventInfoGrid").innerHTML = "<img src='images/vmload.gif' alt='"+translator.common.loader.loading+"' height='36' width='100'/> </br> <p>"+translator.common.alerts.eventLoading+"</p>";
        var eventData = {     
            items: []
        };                   
        ...
        eventAlerts.query().then(function(data) {
            if(data.length == 0 || data == undefined || data == "undefined" || data == "" || data == " ") {
                ...
                dojo.byId("eventInfoGrid").innerHTML = "";
            } else {
                ...
                eventGridWidget.placeAt("eventInfoGrid");
                eventGridWidget.startup();
            }             
        });        
        var eventLayout = [
            [
                {'name': 'ID', 'field': 'id', 'hidden':true, 'width': '160px'},
                ...
                {'name': translator.user.grid.snapshot.layout.type, 'field': 'type', 'width': '150px', 'formatter': function(data) {
                ...
                {'name': translator.common.level, 'field': 'level', 'width': '100px', datatype:"string",  autoComplete: true},
                {'name': translator.common.status.name, 'field': 'state', 'width': '100px', datatype:"string",  autoComplete: true},
                {'name': translator.common.description, 'field': 'description', 'width': '100%', datatype:"string",  autoComplete: true}             
            ]
        ];                     
    }
};
...
var ZoneConfigForMenu = {
    ...
    populateServiceMenu : function (currentZoneId, zoneType) {          
        ...
        dojo.forEach(serviceMenuList, function (el) {
            ...
            Window.DomClass.add(parent, "disable_cursor");
            if(zoneType == "Advanced") {                  
                if(el.id == "serviceMenuIPManager" || el.id == "serviceMenuPortForwarding" || el.id == "serviceMenuSSHKey"|| el.id == "serviceMenuFirewall"|| el.id == "serviceMenuLoadBalancer" || el.id == "serviceMenuVPN" || el.id === "serviceMenuVPC") {                
                    Window.DomClass.add(el, "enable_cursor");
                    Window.DomClass.remove(el, "disable_cursor");  
                    ...
                    if(firstChild.className) {
                        ...
                        if(currentClass[0] == "comingsoon") {
                            Window.DomConstruct.destroy(firstChild); 
                        }                                                    
                    }                
                } else {
                    Window.DomClass.add(el, "disable_cursor");
                    Window.DomClass.remove(el, "enable_cursor");  
                    var adParentLink = dojo.query(el).parent()[0];  
                    var firstChild = adParentLink.firstChild;
                    if(firstChild.className) {
                        var currentClass = firstChild.className.split(" ");
                    ...
                    Window.DomConstruct.place(msgSpan, adParentLink, "first");
                }
                ...
                if(el.id == "serviceMenuIPManager" || el.id == "serviceMenuSSHKey"|| el.id == "serviceMenuFirewall") {                
                    ...
                    Window.DomConstruct.place(msgSpan, currentparentLink, "first");
               }                
           }
       })
   },
    populateValue : function () {                     
        ...
        var allNetworkMenu = [
            ...
            {menuItemName: translator.common.menu.cloud, href: "#/user/cloud/", iconClass: "icon-cloud", subMenu: true, dropdownIcon: "icon-chevron-down", aTagClasses: "dropdown-toggle",
                submenuContent : [
                    {subMenuItemName : translator.common.menu.instance, href : "#/user/cloud/userInstancePage"},
                    {subMenuItemName : translator.common.menu.storage, href : "#/user/cloud/storage"},
                    {subMenuItemName : translator.common.menu.snapShot, href : "#/user/cloud/snapShot"},
                    {subMenuItemName : translator.common.menu.firewall, href : "#/user/cloud/firewall"},
                    {subMenuItemName : translator.common.menu.network, href : "#/user/network"},
                    {subMenuItemName : translator.common.menu.sshKey, href : "#/user/service/sshKey"},                    
                    {subMenuItemName : translator.common.menu.health, href : "#/user/health"},
                    {subMenuItemName : translator.common.menu.limitSummary, href : "#/user/limitSummary"}
                ]
            },                        
            {menuItemName: translator.common.menu.services, iconClass: "iconfgs-menu_service_icon", subMenu: false, dropdownIcon: "icon-chevron-right",  action: true
//                submenuContent : [
//                    {subMenuItemName : translator.common.menu.sshKey, href : "#/user/service/sshKey"},
//                    {subMenuItemName : translator.common.menu.bandwidth, href : "#/user/service/vmBandwidth"},      
//                    {subMenuItemName : translator.common.menu.ipManager, href : "#/user/service/ip"}                              
//                ]
            },              
             
            {menuItemName: translator.common.menu.templates, href: "#/user/template", iconClass: "icon-desktop", subMenu: false, dropdownIcon: "", aTagClasses: "singleMenu"},
            ...
            {menuItemName: translator.common.menu.activity, href: "#/user/home/accountAlert", iconClass: "icon-exchange", subMenu: true, dropdownIcon: "icon-chevron-down", aTagClasses: "dropdown-toggle", 
                submenuContent : [
                    {subMenuItemName : translator.common.menu.events, href : "#/user/home/events"},
...
//                    {subMenuItemName : translator.common.menu.firewall, href : "#/user/cloud/firewall"},
            ...
            {menuItemName: translator.common.menu.services, iconClass: "iconfgs-menu_service_icon", subMenu: false, dropdownIcon: "icon-chevron-right", aTagClasses: "dropdown-toggle", action: true,
//                submenuContent : [
//                    {subMenuItemName : translator.common.menu.sshKey, href : "#/user/service/sshKey"},
//                    {subMenuItemName : translator.common.menu.bandwidth, href : "#/user/service/vmBandwidth"},      
//                    {subMenuItemName : translator.common.menu.ipManager, href : "#/user/service/ip"}                              
...
//                ]
        ...
        zoneListStore.query().then(function(data) {                 
            ...
            if(data == "undefined" || data.length == 0 || data == "") {
                ...
                if(data.length == 1) {
                    if(data[0].networkType == "Basic") {
                        menuContentList = basicNetworkMenu;
                    } else if(data[0].networkType == "Advanced") {
                        menuContentList = advanceNetworkMenu;
                    } else {
                        menuContentList = allNetworkMenu;
                    }
                    dojo.byId("currentAdZoneName").innerHTML = data[0].aliasName;  
                    dojo.byId("selectedANZoneID").value = data[0].referenceZoneId;
                    zoneSelectorWidget = new FogPanel.ZoneSelector ({                        
                        zoneName: data[0].aliasName,
                        onZoneItemClick : function () {
                            ZoneConfigForMenu.showMenuOnZone(this, allNetworkMenu, advanceNetworkMenu, basicNetworkMenu);       
                        },
                        additionalProperties : {
                            zoneId: data[0].referenceZoneId,
            ...
            var currentVpcIP = window.location.hash;
            var urlList = currentVpcIP.split("/");        
            var vmInfo = "";
            if(urlList[4]) {
                vmInfo = urlList[4].split(",");
            }            
            if(currentUrl ===  "#/user/vpc" || currentUrl === "#/user/vpc/help" || currentUrl === "#/user/vpc/topology" || currentUrl ===  "#/user/vpc/vpcContainer" || currentUrl === "#/user/vpc/list" || currentUrl ===  "#/user/vpc/vpcContainer" || currentUrl ===  "#/user/tier/list" || currentUrl ===  "#/user/tier/instance" || currentUrl ===  "#/user/tier/publicLB" ||currentUrl  ===   "#/user/tier/internalLB" ||
                    currentUrl ===  "#/user/tier/publicIP" || currentUrl ===  "#/user/tier/staticNat" || currentUrl ===  "#/user/gateway/privateGateway" || currentUrl ===   "#/user/vpcSecurity" || currentUrl ===  "#/user/vpcSecurity/listNetworkAcl" || 
                    currentUrl ===  "#/user/vpcSecurity/view/" || currentUrl ===  "#/user/vpnCustomerGateway" || currentUrl ===  "#/user/vpnCustomerGateway/list" || currentUrl ===  "#/user/vpnCustomerGateway/vpnConnection" ||currentUrl ===   "#/user/gateway" || 
                    currentUrl ===  "#/user/gateway/vpnGateway" || currentUrl ===  "#/user/gateway/privateGateway" || currentUrl ===   "#/user/vpc/viewVPCPrivateGateway/" || currentUrl ===  "#/user/tier/view/" || currentUrl ===  "#/user/vpc/view/" || 
                    currentUrl ===  "#/user/vpc/viewIp/" ||currentUrl ===   "#/user/vpc/addVpc" || currentUrl ===   "#/user/vpcSecurity/addNetworlAcl" ||currentUrl ===   "#/user/vpnCustomerGateway/add" || (urlList[2] === "vpc"  && urlList[3] === "viewIp" && urlList[4]) 
                    || (urlList[3] === "viewVPCPrivateGateway" && urlList[4]) || (urlList[2] === "tier" && urlList[3] === "view" && urlList[4]) || (urlList[3] === "viewLB" && urlList[4]) || 
                    (urlList[2] === "vpcSecurity" && urlList[3] === "view" && urlList[4]) || (urlList[2] === "vpc" && urlList[3] === "view" && urlList[4]) ||(urlList[2] === "vpc" && urlList[3] === "showVpc" && urlList[4]) ||
                    (urlList[3] === "viewVPCPrivateGateway" && urlList[4]) || (urlList[3] === "vmDetail" && vmInfo[0] && vmInfo[1] === "tier") || (urlList[2] === "tier" && urlList[3] === "instanceList" && urlList[4]) ||
                    (urlList[2] === "tier" && urlList[3] === "addTier") || (urlList[2] === "tier" && urlList[3] === "addInternalLB")) {
                    ...
                    VerticalMenuBar.populateMenu(menuContentList);            
    ...
    showServiceMenuItems : function (currentService) {  
        ...
        var domNode = dojo.byId(currentId); //domNode to which the tooptip must point to                
        ...
        dojo.forEach(menuList, function (menuItem) { 
            ...
            if(menuItem.id === currentId) {                  
                ...
                if(parentNode) {
                    Window.DomClass.add(parentNode, "active");           
                }                       
                    ...
                    if(sibLink) {
                        var wipeOutArgs = {
                            ...
                            onEnd : function() {                                
                                ...
                                Window.DomClass.remove(sibLink, "active");
                                Window.DomClass.remove(otherParent, "active"); 
                            }
                        };                            
    ...
    hideToolTip : function () {
        ...
        Window.DomClass.remove(parentNode, "active");
        ...
        dojo.forEach(menuList, function (menuItem) { 
            ...
            if(BaseMenuItemClassName[2] === "no_bold_text" && menuItem.id !== setviceId) { 
                ...
                dojo.forEach(childrens, function (el) {
                    Window.DomClass.remove(el, "no_bold_text"); 
                })                
                Window.DomClass.remove(menuItem, "no_bold_text");                
            }
        });        
    },
    showMenuOnZone : function (currentZone, allNetworkMenu, advanceNetworkMenu, basicNetworkMenu) {      
        ...
        dojo.byId("currentAdZoneName").innerHTML = currentZone.zoneName;         
        if(currentZone.additionalProperties.networkType === "All" && isAdvanceZoneAviliable === true) {
        ...
        } else if(currentZone.additionalProperties.networkType === "All" && isAdvanceZoneAviliable === false) {
            menuContainer = basicNetworkMenu;
            dojo.byId("selectedANZoneID").value = "All";
            networkType = "Basic";
            vpcStatEnabled = false;
            dojo.byId("selectedANVPCID").value = "";
        } else if(currentZone.additionalProperties.networkType === "Basic") {
            menuContainer = basicNetworkMenu;
            dojo.byId("selectedANZoneID").value = currentZone.additionalProperties.zoneId;
            networkType = "Basic";
            vpcStatEnabled = false;
            dojo.byId("selectedANVPCID").value = "";
        } else if(currentZone.additionalProperties.networkType === "Advanced") {
...
var zoneListStore = new JsonRest({
    ...
    zoneListStore.query().then(function (data) {
        ...
        if(isADZone == true && isBasicZone == true) {
            setTimeout(function () {ZoneConfigForMenu.populateServiceMenu("Advanced", "Advanced");},500); 
        } else if(isADZone == true && isBasicZone == false) {
            setTimeout(function () {ZoneConfigForMenu.populateServiceMenu("Advanced", "Advanced");},500); 
        } else if(isADZone == false && isBasicZone == true) {
            setTimeout(function () {ZoneConfigForMenu.populateServiceMenu("Basic", "Basic");},500); 
        }         
    })    
    });  
