...
var ViewDiskOfferInfo = {
    ...
    populateValues : function(currentId) {
        ...
        this._diskOfferRestStore.get(currentId).then(function(diskOfferData) {            
            ...
            var diskSize = "";
            var cost = "";
            dojo.forEach(diskOfferData.diskOfferZoneCosts, function(zoneData, index) {
                if(diskOfferData.customized === true) {
                    ...
                    cost = (zoneData.cost * diskOfferData.size)*720;                    
                    
                    dojo.byId("diskCostforSizePerMonth").innerHTML = translator.common.costFor + " " + diskOfferData.size + translator.common.gb + "/" + translator.common.month;                          
                    dojo.byId("diskCostforSizePerHr").innerHTML = translator.common.costFor + " " + diskOfferData.size + translator.common.gb + "/" + translator.common.hour;                          
                    dojo.byId("diskCostPerHrPerGb").innerHTML = translator.common.cost + " / " + translator.common.gb + "/" + translator.common.hour; 
                }
              
                var currentZonePrice  = new FogPanel.ZonePrice({
                    id:"disk_zone_widget_"+zoneData.zone.aliasName +"_"+index,
                    zoneName: zoneData.zone.aliasName,
                ...
                currentZonePrice.showOnlyZoneCost();
                currentZonePrice.customDiskActionInfo(diskOfferData.customized);
                dojo.query("#addDiskOfferZoneLoader").toggleClass("hide_text", true);
                dojo.query("#diskZoneCost").removeClass("hide_text", true);
                dojo.query("#diskZonePriceLabelContainer").removeClass("hide_text", true);                                                             
            });                      
