    ...
    populateValues: function() {   
        ...
        var summaryLayout = [
            [
                ...
                {'name': translator.common.cost + " " + translator.common.gbPerMonth + " ("+ core.getCurrency() +")", 'field': 'cost', 'width' : '100%', datatype:"string",  autoComplete: true, 'formatter' : function(data) {
                        var html = "<span class='adminBolder'>"+ data + "</span>"
                        return html;
                    }
                }                    
...
var MiscSnapshotInfo = {
    ...
    populateValues: function() {   
        ...
        var summaryLayout = [[
                 ...
                 {'name': translator.common.cost + " " + translator.common.gbPerHr + " ("+ core.getCurrency() +")", 'field': 'cost', 'width' : '100%', datatype:"string",  autoComplete: true, 'formatter' : function(data) {
                        var html = "<span class='adminBolder'>"+ data + "</span>"
                        return html;
                 }
             }                    
...
var MiscIpInfo = {
    ...
    populateValues: function() {   
        ...
        var summaryLayout = [[
                 ...
                 {'name': translator.common.CostPerIPPerMonth  + " ("+ core.getCurrency() +")", 'field': 'cost', 'width' : '100%', datatype:"string",  autoComplete: true, 'formatter' : function(data) {
                       var html = "<span class='adminBolder'>"+ data + "</span>"
                       return html;  
                 }}
...
var MiscPortForwardingInfo = {
    ...
    populateValues: function() {   
        ...
        var summaryLayout = [[
                 ...
                 {'name': translator.common.CostPerRulePerMonth + " ("+ core.getCurrency() +")", 'field': 'cost', 'width' : '100%', datatype:"string",  autoComplete: true, 'formatter' : function(data) {
                       var html = "<span class='adminBolder'>"+ data + "</span>"
                       return html;  
                 }}
        ...
        this._clusterWidget = new FilteringSelect({
            ...
            onChange : function() {                             
                ...
                if(data.length == 0 || data == undefined || data == 'undefined' || data == '' || data == " ") { 
                    ...
                    dojo.forEach(data, function(miscData) {                        
                        miscelWidget.zoneCost =  miscData.cost;
                        miscelWidget.labelName =  translator.common.CostPerRulePerMonth + span;      
                        miscelWidget.setZoneId(miscData.zone.id);
                        miscelWidget.setCost();                        
                    })   
                }                                    
        ...
        var currentZoneCost  = new Zone.ZoneCost({
            ...
            vmRunningCostLabel: translator.common.CostPerRulePerMonth + span,
            invalidMsg : translator.common.zoneCostInvalidMsg
        });     
        currentZoneCost.removeCosts();    
        currentZoneCost.removeUnitCost();   
...
var MiscLoadBalancerInfo = {
    ...
    populateValues: function() {           
        ...
        var summaryLayout = [[
                 ...
                 {'name': translator.common.CostPerPolicyPerMonth + " ("+ core.getCurrency() +")", 'field': 'cost', 'width' : '100%', datatype:"string",  autoComplete: true, 'formatter' : function(data) {
                       var html = "<span class='adminBolder'>"+ data + "</span>"
                       return html;  
                 }}
...
//                  core.router.go("#/admin/miscellaneous/snapshot");
    ...
    populateValues: function() {   
        ...
        var summaryLayout = [[
                 ...
                 {'name': translator.common.CostPerConnectionPerMonth + " ("+ core.getCurrency() +")", 'field': 'cost', 'width' : '100%', datatype:"string",  autoComplete: true, 'formatter' : function(data) {
                       var html = "<span class='adminBolder'>"+ data + "</span>"
                       return html;  
                 }}
