...
var PromotionCodeManagement = {
    ...
    populateValues : function() {
        ...
        var promotionDataLayout = [[
                 ...
                 {'name': translator.common.promotionValue + " ("+ core.getCurrency() +")", 'field': 'promotionValue', 'width': '150px', 'datatype':'string',  'autoComplete': 'true'},
         ...
         this._promotionRestStore.query().then(function(data) {
             dojo.forEach(data, function(promotionData) {
                 promotionDataList.newItem({
                     ...
                     promotionValue: localeCurrency.format(promotionData.promotionValue) ,
