...
<div class="row-fluid filter-block">
    <div class="pull-right" id="publicIPListActionButtonCollection">
        <input type="hidden" id="currentGeneralIPId">
        <input type="hidden" id="currentGeneralEnableStaticNatIpId">
        <a class="btn-flat success new-product" onclick="ListAllPublicIPInfo.populateValues();"><i class="icon-refresh"></i> <g:message code='common.refresh' /></a> 
    ...
    <div class="row-fluid">
      <div class="alert alert-info hide" id="noGeneralPublicIPMsg" style="display: none">
        ...
        <span id="noPublicIPMsg"><g:message code="common.user.vpc.noNetworkIp"/></span>
      </div>
    </div>
</div>
...
<div data-dojo-type="dijit.Dialog" id="vpcGenerealIpEnableStaticNatDialog" title="<g:message code="common.enableStaticNat"/>" class="span4"> 
    ...
    <form id="vpcGeneralEnableStaticNatForm" data-dojo-type="dijit.form.Form" accept-charset="" class="form-horizontal">	
        ...
        <div class="span9" id="vpcIpEnableStaticNatFormPage">
            ...
            <div class="row-fluid">
            <div class="span6"><span  class="hide_text require" id="enableStaticNatErrorMessage"><g:message code="user.createVM.required"/></span></div>
            <div class="span6">
