...
<div class="row-fluid filter-block">
    <div class="pull-right" id="vmListActionButtonCollection">
        <input type="hidden" id="currentGeneralTierVmID"/>
        <a class="btn-flat success new-product" onclick="ListAllVPCVMInfo.populateValues()"><i class="icon-refresh"></i> <g:message code='common.refresh' /></a>    
    ...
    <div class="row-fluid">
      <div class="alert alert-info hide" id="noGeneralVPCMVMsg" style="display: none">
        ...
        <span id="noVMMsg"><g:message code="common.user.noVMForNetworkIP"/></span>
      </div>
    </div>
</div>
