...
<div class="row-fluid" id="acquireIpPageDiv">
    <form class="form-horizontal" data-dojo-type="dijit.form.Form">
        ...
        <button  type="button" class="primarybtn span2" data-dojo-type="dijit.form.Button" onclick="CurrentVMSecondaryIP.nicAcquireIpShow()"><g:message code="common.acquireIP"/></button>
    </form>
</div>
<div class="row-fluid">
