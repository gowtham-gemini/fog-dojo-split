                        ...
                        <div class="router-cont">
                            ...
                            <div class="router-info-boxlst tiers-info-desc">
                                ...
                                <div  class="span2 field_box">
                                    <a class="no_cursor">
                                        <div class="info-boxlist-value" id="vpcCIDRValue" style="font-size: 14px;"></div>
...
<!--                    <div class="row-fluid">
        ...
        <div data-dojo-type="dijit/layout/ContentPane" id="vpcs2sVpnTab" title="<g:message code="common.S2SVPNGateways"/>" onShow="SiteToSiteVPN.list()">
            <div class="row-fluid filter-block">
                <div class="pull-right" id="createVPNS2S">
                    <button  data-dojo-type="dijit.form.Button" onclick="SiteToSiteVPN.list()" class="okbtn">
                        <i class="icon-refresh"></i> <g:message code='common.refresh' />
                    </button>
                    <button  data-dojo-type="dijit.form.Button" onclick="SiteToSiteVPN.createS2SGatewayShow()" class="okbtn">
                        ...
                        <form class="form-horizontal" id="addVPNConnectionForm" data-dojo-type="dijit.form.Form">
                            <div class="row-fluid">  
                                ...
                                <div id="addVPNConnectionPage" class="span9" style="position: absolute; margin-top: 10px;">
                                    ...
                                    <div class="span6">
                                        <button  type="button" class="primarybtn" data-dojo-type="dijit.form.Button" onclick="VPNConnection.showCreateDialog()"><g:message code="common.createVpnConnection"/></button>
                                        <button  data-dojo-type="dijit.form.Button" onclick="VPNConnection.populateValues()" class="okbtn">
                                            <i class="icon-refresh"></i> <g:message code='common.refresh' />
                                        </button>
                                    </div>
                                </div>
        ...
        <div onShow="VPCPrivateGateway.populateValues()" id="vpcPrivateGatewayTab" data-dojo-type="dijit/layout/ContentPane" title="<g:message code="common.privateGateway"/>" selected="true">
            <div class="table-wrapper products-table">
                <div class="pull-right">
                    <button  data-dojo-type="dijit.form.Button" onclick="VPCPrivateGateway.populateValues()" class="okbtn">
                        <i class="icon-refresh"></i> <g:message code='common.refresh' />
                    </button>
                </div>
                <div class="row-fluid filter-block">
        ...
        <div onShow="VPCNetworkACLInfo.populateValues()" id="vpcNetworkACLTab" data-dojo-type="dijit/layout/ContentPane" title="<g:message code="common.networkAcl"/>" selected="true">
            <div class="table-wrapper products-table">
                ...
                <div class="row-fluid filter-block">
                    <div class="pull-right">                       
                        <a class="btn-flat success new-product" onclick="VPCNetworkACLInfo.populateValues()"><i class="icon-refresh"></i> <g:message code='common.refresh' /></a>
                        <a class="btn-flat success new-product" onclick="VPCNetworkACLInfo.showAddACLDialog()">+ <g:message code="common.add"/></a>
                    </div>
                </div>
                <div class="row-fluid"> 
...
<div data-dojo-type="dijit.Dialog" id="vpcNetworkAclDeleteDialog" class="span4">    
    <div class="row-fluid">
        <div class="span2"><img src="images/vm_delete_icon.png"></div>
        <div class="span10">
...
<div data-dojo-type="dijit.Dialog" id="createS2SGatewayDialog"  class="span4" title="<g:message code="common.S2SVPNGateways"/>">
    <input type="hidden" id="currentS2SVPNID">
    <div class="row-fluid">
        <div class="span2"><a class="srv-submenu-title-vpn span12"></a></div>
        <div class="span10">
...
<div data-dojo-type="dijit.Dialog" id="createAclConnectionPage" class="span4" title="">
    <div class="row-fluid">
        <div class="span2"><a class="index_title_icons_cldinstances span12"></a>  </div>
         <div class="new-user createVm span9"> 
...
<div data-dojo-type="dijit.Dialog" id="vpcInfoDeleteDialog" class="span4" title="<g:message code="common.delete"/>">
...
<div data-dojo-type="dijit.Dialog" id="vpcInfoRestartDialog" class="span4"  title="<g:message code="common.restart"/>">
    <input id="currentVpcId" type="hidden">
    <div class="row-fluid">
...
<div data-dojo-type="dijit.Dialog" id="vpcInfoListEditDialog" class="span4" title="<g:message code="common.edit"/>"> 
    <input type="hidden" id="currentVpcId">
    <div class="row-fluid container">
