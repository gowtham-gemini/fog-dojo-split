...
<div class="row-fluid"> 
    <div id="main-stats">
        <div class="row-fluid stats-row">
            ...
            <div class="span4 stat">
                <div class="data">
                  <span class="number" id="userIsolatedNetwork">0</span>
                    <g:message code="stat.user.isolatedNetwork"/>
                </div>

            </div>
            <div class="span4 stat">
                <div class="data">
                  <span class="number" id="userSharedNetwork">0</span>
                   <g:message code="stat.user.sharedNetwork"/>
                </div>            
            </div>
        </div>
    </div>
