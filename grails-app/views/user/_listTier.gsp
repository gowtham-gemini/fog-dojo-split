...
<div class="row-fluid filter-block">
    <div class="pull-right" id="tierListActionButtonCollection">
        ...
        <a class="btn-flat success new-product" onclick="ListTierInfo.populateValues();"><i class="icon-refresh"></i> <g:message code='common.refresh' /></a>
    ...
    <div class="row-fluid">
      ...
      <div data-dojo-type="dijit.Dialog" id="generalTierReplaceACLDialog" class="span4" title="<g:message code="common.ACL"/>">    
    <div class="row-fluid">
...
<div data-dojo-type="dijit.Dialog" id="generalTierRestartDialog" class="span4" title="<g:message code='common.restart'/>">
...
<div data-dojo-type="dijit.Dialog" id="generalTierEditConformDialog" class="span4" title="<g:message code="common.edit"/>">
    <input id="currentTierId" type="hidden">
    <div class="row-fluid">
        <div class="span2"><img src="images/edit.png"></div>
        <div class="span10">
...
<div data-dojo-type="dijit.Dialog" id="generalTierDeleteDialog" class="span4" title="<g:message code="common.delete"/>">
    <input id="currentTierId" type="hidden">
    <div class="row-fluid">
