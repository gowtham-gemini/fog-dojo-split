                ...
                <div class="span12">
                    ...
                    <div class="span6">
                        ...
                        <div class="control-group span12">
                            ...
                            <div class="controls" id="planTypeContainer">      
                                <div class="span6">
                                    <input type="radio" checked="true" data-dojo-type="dijit.form.RadioButton" onclick="CurrentVMStorageInfo.showCustomDisk(this)"  name="diskType" id="diskPlanDiskRadio" value="plan"/>
                                    <label style="float: left;" for="diskPlanDiskRadio"><g:message code='common.plans' /></label> 
                                </div>
                                <div class="span6">
                                    <input type="radio" data-dojo-type="dijit.form.RadioButton" onclick="CurrentVMStorageInfo.showCustomDisk(this)" name="diskType"  id="diskCustomDiskRadio" value="custom"/> 
                                    <label style="float: left;" for="diskCustomDiskRadio"><g:message code='common.custom' /></label>       
                                </div>                                                                                          
                            </div>
                        </div>
                        ...
                        <div class="control-group span12" id="vm-disk-billingTypeDiv">
                            ...
                            <div class="controls" id="storageBillingTypeContainer">                                
                                <div class="span6">
                                    <input type="radio" checked="true" data-dojo-type="dijit.form.RadioButton" onclick="CurrentVMStorageInfo.enableMonthlyCost(this)"  name="billingType" id="diskBillingTypeHourlyRadion" value="hourly"/>
                                    <label style="float: left;" for="diskBillingTypeHourlyRadion"><g:message code='common.hourly' /></label> 
                                </div>
                                <div class="span6">
                                    <input type="radio" data-dojo-type="dijit.form.RadioButton" onclick="CurrentVMStorageInfo.enableMonthlyCost(this)" name="billingType"  id="diskBillingTypeMonthlyRadion" value="monthly"/> 
                                    <label style="float: left;" for="diskBillingTypeMonthlyRadion"><g:message code='common.monthly' /></label>       
                                </div> 
                                
                                    <!--<div id="diskBillingTypeSwitch" data-dojo-type="dojox.mobile.Switch" class="mblSwRoundShape1" value="off"  data-dojo-props="leftLabel: '', rightLabel: ''"></div>-->
