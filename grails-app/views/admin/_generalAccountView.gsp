      ...
      <div class="row-fluid overflow-text">
        ...
        <div class="span12 field-box" style="display: none">
          ...
          <div class="span12 field-box">
              ...
              <span id="currentAcCreditLimit" class="pull-right span7 labelValues"></span>
        ...
        <div class="span12 field-box">
            ...
            <span id="currentAcPaid" class="pull-right span7 labelValues"></span>
          </div>
        <div class="span12 field-box">
            <label class="headerLabel min_width_label"><g:message code="common.due"/></label>
            <span id="currentAcDue" class="pull-right span7 labelValues"></span>
          </div>    
        <div class="span12 field-box">
            <label class="headerLabel min_width_label"><g:message code="common.refund"/></label>
            <span id="currentAcRefund" class="pull-right span7 labelValues" style="color: #D30000">0.0</span>
          </div>                                            
         <div class="span12 field-box">
         ...
         <div class="span12 field-box">
             ...
             <span id="currentAcIncome" class="pull-right span7 labelValues" style="color: #FF9900; font-size: 18px ">0.0</span>
         </div>          
        </div>
        <div style="float:left; width:1px;height:210px;background:#ccc;"></div>
        <div class="span1">
          ...
          <div class="span12 field-box" id="resourceUpdateDiv">
