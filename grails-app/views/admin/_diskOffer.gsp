...
<div class="row-fluid">
    <div class="span12" id="adminDiskOfferPage">
        <div class="row-fluid header">
            <h3><g:message code="common.admin.disk.addHeding"/></h3> 
        ...
        <div class="span12" id="diskOfferingPage"> 
            ...
            <div class="row-fluid" id="diskOfferContent">
                <form id="diskOfferContentForm" data-dojo-type="dijit.form.Form" class="form-horizontal"> 
                    ...
                    <div class="row-fluid" id="diskBillingInfo">       
                        <div class="row-fluid header">            
                            <h3><g:message code="common.pricingInfo"/></h3>        
                        </div> 
                        <div class="row-fluid" id="diskZonePriceLabelContainer">                
                            <div>
                                <div class="row-fluid">
                                    <div class="span2"><h5><g:message code="common.zoneName"/></h5></div>
                                    <div class="span2"><h5 id="diskCostforSizePerMonth"></h5></div>
                                    <div class="span2"><h5 id="diskCostforSizePerHr"></h5></div>
                                    <div class="span2"><h5 id="diskCostPerHrPerGb"></h5></div>                                    
                                </div>
                            </div>
                        </div>
                        <div id="currentDiskZoneInfo" class="row-fluid">                           
                            <div class="span12"><div id="diskZoneCost" class="span12"></div></div>                            
                        </div> 
                        <div class="row-fluid hide_text" id="addDiskOfferZoneLoader">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span3">
                            ...
                            <div id="diskAddButtonDiv" class="span2">
                                <button type="button" data-dojo-type= "dijit.form.Button"  onclick="AddDiskOfferInfo.add()" id="diskAddButton" class="okbtn">
