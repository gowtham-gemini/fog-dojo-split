            ...
            <div class="container">
                <form class="new_user_form form-horizontal" data-dojo-type="dijit.form.Form" id="invoiceForm">
                    ...
                    <div class="span12 field-box control-group">
                        ...
                        <div class="controls">
                            <input type="text" data-dojo-type="dijit.form.ValidationTextBox" data-dojo-props="invalidMessage: '<g:message code="common.value.invalid"/>',required: 'required', placeHolder: '<g:message code="common.enterNoOfDays"/>', promptMessage:'<g:message code="common.enterNoOfDays"/>',regExp:'[0-9]{1,200}'" name="paymentDueDays" id="paymentDueDays">  
                        </div>
                    </div>
                    <div class="span12 field-box control-group">
