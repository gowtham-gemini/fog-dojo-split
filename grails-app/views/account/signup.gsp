...
<html lang="${lang}">
  ...
  <body class="fog-classic" id="signupPage" onload="app.signup.checkEmailFromInvitation()">
    <div class="row-fluid">
      <div id="loader"></div>
      </div>    
...
<!--                  <div class="span3 validationErrorMsg" id="emailValidateMsg">
                ...
                <div class="control-group span9"> 
                  ...
                  <div class="controls">
                    <input type="text" data-dojo-type="dijit.form.ValidationTextBox" 
                           ...
                           missingMessage: '<g:message code="common.promptMessage.firstName"/>',required: true,regExp:'[a-zA-Z0-9- ]{1,200}',
              ...
              <div class="control-group span9"> 
                ...
                <div class="controls">
                  <input type="text" data-dojo-type="dijit.form.ValidationTextBox" 
                         ...
                         missingMessage: '<g:message code="common.promptMessage.lastName"/>',required: true,regExp:'[a-zA-Z0-9- ]{1,200}',
            ...
            <div data-dojo-type="dojox.widget.WizardPane" id="wizard_page_2" 
              ...
              <div class="control-group span9"> 
                ...
                <div class="controls">
                  <input type="text" data-dojo-type="dijit.form.ValidationTextBox" 
                         data-dojo-props="promptMessage:'<g:message code="common.promptMessage.companyName"/>',regExp:'[a-zA-Z0-9- ]{1,200}',                         
                ...
                <div class="controls">
                   <input type="text" data-dojo-type="dijit.form.ValidationTextBox"
                         data-dojo-props="required: true, promptMessage: '<g:message code="common.promptMessage.address1"/>',
                            missingMessage: '<g:message code="common.promptMessage.address1"/>',regExp: '[a-zA-Z0-9#$%!_@|&*?+-/\ ^:]{4,250}',
              ...
              <div class="control-group span9"> 
                ...
                <div class="controls">
                   <input type="text" data-dojo-type="dijit.form.ValidationTextBox"
                         data-dojo-props="promptMessage: '<g:message code="common.promptMessage.address2"/>',regExp: '[a-zA-Z0-9#$%!_@|&*?+-/\ ^:]{4,250}',
              ...
              <div class="control-group span9"> 
                ...
                <div class="controls">
                  <input type="text" data-dojo-type="dijit.form.ValidationTextBox"
                           data-dojo-props="required: true, promptMessage: '<g:message code="common.promptMessage.city"/>',regExp:'[a-zA-Z0-9- ]{1,200}', 
