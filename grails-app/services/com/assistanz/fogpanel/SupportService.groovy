...
//        }
    ...
    def getTicket(id) {
        ...
        try {  
            ...
            def dateFormatValue = configService.getDateFormat();             
            SimpleDateFormat dateFormat = new SimpleDateFormat("EEE, " + dateFormatValue.toString() +" HH:mm");
    ...
    def getDefaultReply(id) {
        ...
        try {  
            ...
            HashMap item = new HashMap();  
            item.put("id",  rep.id);
            item.put("subject",  StringEscapeUtils.escapeHtml(rep.subject));
            item.put("content",  StringEscapeUtils.escapeHtml(rep.content));
            ticListArray.add(item)
    ...
    def listDepartment(requestBody) {
        ...
        try {  
            ...
            for(def dep: depList) {
                ...
                HashMap<String,String> item = new HashMap<String,String>();  
                item.put("id",  dep.id);
                item.put("name",  StringEscapeUtils.escapeHtml(dep.name));
    ...
    def listDefaultReply(departmentId) {
        ...
        try {
            ...
            for(def reply: replyList) {
                ...
                item.put("content",  StringEscapeUtils.escapeHtml(reply.content));
                item.put("subject",  StringEscapeUtils.escapeHtml(reply.subject));
                item.put("department",  StringEscapeUtils.escapeHtml(reply.department.name));
