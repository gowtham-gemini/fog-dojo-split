            ...
            HashMap<String,String> cloudStackDiskList = new HashMap<String,String>(); 
             ...
             for(Iterator<VolumeResponse> iter = response.volumes.iterator(); iter.hasNext();) {
                ...
                if (!volume) {                    
                    ...
                    volume.owner = Account.findByUserName(data.diskVolumeAccount);
        ...
        try {
            ...
            for(int i=0; i < result.size(); i++) { 
                ...
                HashMap<String,String> volumeItem = new HashMap<String,String>();                
                    ...
                    volumeItem.put("owner", item.owner.userName);
    ...
    def create(String requestBody) {
        try {
            ...
            Volume.withTransaction {
                ...
                newVolume.volumeReferenceId = response.diskVolumeId;
                ...
                if(response) {                
                    for(Iterator<VolumeResponse> iter = response.volumes.iterator(); iter.hasNext();) {
                        ...
                        if(data) {                        
                            ...
                            Volume newVolume = Volume.findByVolumeReferenceId(data.diskVolumeId);                               
                            newVolume.storageName = data.diskVolumeStorage;
