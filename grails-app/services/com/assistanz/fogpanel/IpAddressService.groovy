...
class IpAddressService {
    ...
    def addVpnUser(requestBody) {
        try {
            ...
            item.put("vpnUserId", vpnUserResponse.vpnUserId);           
    ...
    def listVPNUsers() {
        ...
        for(int i =0 ; i < vpnUsers.size(); i++) {
            ...
            item.put("account", user.account.userName);
            ...
            for(Iterator <IpAddressResponse> iter = response.ipAddresses.iterator(); iter.hasNext();) {
                ...
                if(!userIPAddress) {
                    ...
                    if(userIPAddress.isSourceNat == true) {
                        ...
                        def network = Network.findByReferenceId(data.publicIpAddressAssociatedNetworkid)
