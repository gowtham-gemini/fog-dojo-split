...
class Account {
	...
	Country billingCountry
        ...
        String vmLimit = "-1"
        String storageLimit = "-1"
        String snapshotLimit = "-1"
        String bandwidthLimit
        
        String publicIPLimit = "-1"
        String vpcLimit = "-1"
        String cpuLimit = "-1"
        String memoryLimit = "-1"
        String networkLimit = "-1"
        String primaryStorageLimit = "-1"
        String secondaryStorageLimit = "-1"
...
//        Date createdDate
	...
	static constraints = {
		...
		billingCountry (maxSize: 100, nullable: false, blank: false)
                ...
                networkLimit(nullable: true, blank: true)
                
                
                publicIPLimit(nullable: true, blank: true)
                vpcLimit(nullable: true, blank: true)
                cpuLimit(nullable: true, blank: true)
                memoryLimit(nullable: true, blank: true)
                primaryStorageLimit(nullable: true, blank: true)
                secondaryStorageLimit(nullable: true, blank: true)
